        ...
        child: new SingleChildScrollView(
          child: new Column(
            ...
            children: <Widget>[
              ...
              new Text(
                "1.4 We may update or change the application from time to time to reflect changes to our products, our users' needs and/or our business priorites.",
                style: new TextStyle(
                    fontSize: UIData.fontSize16, color: UIData.blackOrWhite),
              ),
              new Padding(
              ...
              new Text(
                "Our Privacy Notice https://www.digitaleunge.com/, which sets out the terms on which we process any personal data we collect from you, or that you provide us. By using the application, you consent to such processing and you warrant tht all data provided by you is accurate.",
                style: new TextStyle(
                    fontSize: UIData.fontSize16, color: UIData.blackOrWhite),
              ),
              new Padding(
              ...
              new Text(
                "4.6 If you wish to complain about User Content uploaded by other users please contant us at preflopapp@gmail.com",
                style: new TextStyle(
                    fontSize: UIData.fontSize16, color: UIData.blackOrWhite),
              ),
              new Padding(
              ...
              new Text(
                "5.5 We shall (a) prepare the application and Our Content with reasonable skill and care; and (b) use industry strandard virus detection software to try to black the uploading of content to the application that contains viruses.",
                style: new TextStyle(
                    fontSize: UIData.fontSize16, color: UIData.blackOrWhite),
              ),
              new Padding(
              ...
              new Text(
                "5.7 Although we make reasonable efforts to update the information on our site, we make no representations, warranties or guarantess, whether express or implied, that Our Content is accurate, complete or up to date.",
                style: new TextStyle(
                    fontSize: UIData.fontSize16, color: UIData.blackOrWhite),
              ),
              new Padding(
              ...
              new Text(
                "6.1 The application may contain links to websites or applications operated by third parties. We do not have any influence or control over any such third party websites or applications or the third party operater. We are not responsible for and do not endorse any third party websites or applications or their availability or content.",
                style: new TextStyle(
                    fontSize: UIData.fontSize16, color: UIData.blackOrWhite),
              ),
              new Padding(
              ...
              new Text(
                "6.2 We accept no resposibility for adverts contained within the application. If you agree to purchase goods and/or services from any third party who advertises in the application, you do so at your own risk. The advertiser, and not us, is responsible for such good and/or services and if you have any questions or complaints in relation to them, you should contact the advertiser.",
                style: new TextStyle(
                    fontSize: UIData.fontSize16, color: UIData.blackOrWhite),
              ),
              new Padding(
              ...
              new Text(
                "8.3 There may be information on the application that contains typographical errors, inaccuracies, or omissions that may relate to the services, inlcuding descriptions, pricing, availability, and various other informartion. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information at any time, without prior notice.",
                style: new TextStyle(
                    fontSize: UIData.fontSize16, color: UIData.blackOrWhite),
              ),
              new Padding(
              ...
              new Text(
                "9. Disclaimer/Limitation of Liabaility",
                style: new TextStyle(
                    fontSize: UIData.fontSize20,
                    color: UIData.blackOrWhite,
                    fontWeight: FontWeight.bold),
