...
class SelectionCallbackExamplee extends StatefulWidget {
  final List<charts.Series> seriesList;
  final bool animate;

  SelectionCallbackExamplee(this.seriesList, {this.animate});

  /// Creates a [charts.TimeSeriesChart] with sample data and no transition.
  factory SelectionCallbackExamplee.withSampleData() {
    return new SelectionCallbackExamplee(
      _createSampleData(),
...
class _SelectionCallbackState extends State<SelectionCallbackExamplee> {
  DateTime _time;
